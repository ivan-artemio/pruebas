	...
	<div class="box box-primary">	
		...
		<div class="box-footer">
		    <form method="POST" enctype="multipart/form-data" class="form" id="formp" name="formp" action="javascript:guardar()" autocomplete="off">
		        ...
		        <p>
		        	<div id="mensaje"></div>
		            <a class="btn" href="{$_layoutParams.root}">Salir</a>
...
function guardar(){
	...
	$.ajax({
                ...
                url:   '{$_layoutParams.root}usuarios/perfil/guardarUsuario',
                type:  'POST',
				//dataType: 'json',
	              ...
	              action: function(dialogRef)
	              {
	                dialogRef.close();
	                    if(salir && (tipo == 1 || tipo == 2)){
	                        window.location="{$_layoutParams.root}";
	                    }
	              }
	            }],
	            onhidden: function(dialogRef){
